	     ...
	     columns:[[
	       ...
	       },
	       {
	        ...
	        {field:'action',title:'操作',width:100,
	    	 ...
	    	 if($scope.so_grant)str += $.formatString('<img ng-show="so_grant" style="float:left;" onclick="$(this).scope().grant(\'{0}\');" src="{1}" title="授权"/>',row.id,PATH+'/static/js/ext/style/images/extjs_icons/key.png');
	    	 if($scope.so_pwd)	str += $.formatString('<img ng-show="so_pwd" style="float:left;" onclick="$(this).scope().pwd(\'{0}\');" src="{1}" title="修改密码"/>',row.id,PATH+'/static/js/ext/style/images/extjs_icons/key_add.png');
	    	 if($scope.so_freeze)str += $.formatString('<img ng-show="so_freeze" style="float:left;" onclick="$(this).scope().freeze(\'{0}\',\'{1}\');" src="{2}" title="冻结"/>',row.id, row.status,PATH+'/static/js/ext/style/images/extjs_icons/lock/lock.png');
