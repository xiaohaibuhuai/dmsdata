MainApp.controller('MttChartCtrls', function($scope,TabService) {
	
	var initInc = false;
//	   初始化图表
	 $.post(PATH+'/data/monitoring/moneysystem/mttchart/mttChange',function(data){
...
//				},
	 ...
	 $.post(PATH+'/data/monitoring/moneysystem/mttchart/recharge',function(data){
