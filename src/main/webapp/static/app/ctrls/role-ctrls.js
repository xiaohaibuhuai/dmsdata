	...
	$('#pid').combotree({
	  ...
	  treeGrid = $('#treeGrid').treegrid({
		...
		columns : [ [ {
			...
			str += '&nbsp;';
			if($scope.so_grant)	str += $.formatString(' <img ng-show="so_grant" onclick="$(this).scope().grantFun(\'{0}\');" src="{1}" title="授权"/> ', row.id, PATH+'/static/js/ext/style/images/extjs_icons/key.png');
			str += '&nbsp;';
