...
public class QuartzManager {  
    ...
    private static String JOB_GROUP_NAME = "OMS_JOBGROUP_NAME";  
    private static String TRIGGER_GROUP_NAME = "OMS_TRIGGERGROUP_NAME";  
     ...
     * @return
     */
    public static String getCronFormDate(Date date){
    ...
    public static void main(String[] args){
    	System.out.println(getCronFormDate(new Date()));
